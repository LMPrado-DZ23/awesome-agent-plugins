...
export const CLIENTS = {
  'claude-code': {
    name: 'Claude Code', instructionsTarget: 'CLAUDE.md', docs: 'https://code.claude.com/docs/en/mcp', skillsAgent: 'claude-code', instructions: 'CLAUDE.md',
    mcp(e) {
  ...
  codex: {
    name: 'Codex CLI', instructionsTarget: 'AGENTS.md', docs: 'https://developers.openai.com/codex/mcp', skillsAgent: 'codex', instructions: 'AGENTS.md',
    mcp(e) {
      const n = serverName(e), { stdio: s, http: h } = e.mcp;
      if (s) {
        const env = envPairs(s.env).map(([k, v]) => `--env ${k}=${q(v)} `).join('');
  ...
  'gemini-cli': {
    name: 'Gemini CLI', instructionsTarget: 'GEMINI.md', docs: 'https://github.com/google-gemini/gemini-cli/blob/main/docs/tools/mcp-server.md', skillsAgent: 'gemini-cli', instructions: 'GEMINI.md',
    mcp(e) {
      const n = serverName(e), { stdio: s, http: h } = e.mcp;
      if (s) {
