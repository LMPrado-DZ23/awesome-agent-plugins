...
- [Google Workspace CLI](#googleworkspace-cli) — Ferramenta de linha de comando única para Drive, Gmail, Calendar, Sheets, Docs, Chat e Admin, gerada dinamicam…
...
[googleworkspace/cli](https://github.com/googleworkspace/cli) — `Plugin nativo` · ★ 31k · Licença: Apache-2.0 · Funciona com: Gemini CLI apenas

Ferramenta de linha de comando única para Drive, Gmail, Calendar, Sheets, Docs, Chat e Admin, gerada dinamicamente a partir do Google Discovery Service e acompanhada de agent skills.
...
[czlonkowski/n8n-mcp](https://github.com/czlonkowski/n8n-mcp) — `Agent Skills` · ★ 23k · Licença: MIT · Funciona com: Todos os clientes

Servidor MCP e conjunto de skills que permitem ao Claude Desktop, Claude Code, Windsurf ou Cursor construir, validar e configurar workflows e nós de automação do n8n.
...
[Finance Toolkit](https://github.com/JerBouma/FinanceToolkit) — `Servidor MCP` · ★ 5.4k · Licença: MIT · Funciona com: Todos os clientes
...
[Tolgee](https://github.com/tolgee/tolgee-platform) — `Servidor MCP` · ★ 4.1k · Licença: ver repo · Funciona com: Todos os clientes
...
[ZeframLou/call-me](https://github.com/ZeframLou/call-me) — `Agent Skills` · ★ 2.6k · Licença: ver repo · Funciona com: Todos os clientes

Plugin minimalista que permite ao Claude Code ligar para o seu telefone, útil como canal de notificação quando uma tarefa longa termina ou precisa de atenção.
...
[Kaelio/ktx](https://github.com/Kaelio/ktx) — `Agent Skills` · ★ 1.6k · Licença: Apache-2.0 · Funciona com: Todos os clientes

Skills de contexto executável que permitem a agentes de dados e analytics consultar dbt, Looker, LookML, Metabase e MetricFlow com precisão, ingerindo a camada semântica real de cada ferramenta.
...
[Power BI Modeling MCP Server](https://github.com/microsoft/powerbi-modeling-mcp) — `Servidor MCP` · ★ 1.2k · Licença: MIT · Funciona com: Todos os clientes
