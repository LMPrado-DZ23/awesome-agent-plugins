...
[ai-dashboad/flutter-skill](https://github.com/ai-dashboad/flutter-skill) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[Compiler Explorer](https://github.com/compiler-explorer/compiler-explorer) — `Servidor MCP` · Licença: BSD-2-Clause · Funciona com: Todos os clientes
...
[robotmcp/ros-mcp-server](https://github.com/robotmcp/ros-mcp-server) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[8beeeaaat/touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[Apollo MCP Server](https://github.com/apollographql/apollo-mcp-server) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[Postman MCP Server](https://github.com/postmanlabs/postman-mcp-server) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[Keploy](https://github.com/keploy/keploy) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[Godot MCP](https://github.com/tugcantopaloglu/godot-mcp) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
- [HaD0Yun/godot-mcp](https://github.com/HaD0Yun/godot-mcp) — Mais de 95 ferramentas para o Godot Engine, com suporte a LSP, DAP e capturas de tela.
- [Glade-tool/glade-mcp](https://github.com/Glade-tool/glade-mcp) — Controla tanto o editor Unity quanto o Godot: cenas, scripts, física e materiais.
...
[blitzdotdev/blitz-mac](https://github.com/blitzdotdev/blitz-mac) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[Opik MCP Server](https://github.com/comet-ml/opik-mcp) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[kubeshop/testkube](https://github.com/kubeshop/testkube) — `Servidor MCP` · Licença: ver repo · Funciona com: Todos os clientes
...
[vercel/next-devtools-mcp](https://github.com/vercel/next-devtools-mcp) — `Servidor MCP` · Licença: ver repo · Funciona com: Todos os clientes
...
[nrwl/nx-console](https://github.com/nrwl/nx-console) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[rustunnel](https://github.com/joaoh82/rustunnel) — `Servidor MCP` · Licença: AGPL-3.0 · Funciona com: Todos os clientes
...
[ClaudeR - RStudio MCP Server](https://github.com/IMNMV/ClaudeR) — `Servidor MCP` · Licença: ver repo · Funciona com: Todos os clientes
...
[LLM Sandbox](https://github.com/vndee/llm-sandbox) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes

Executa com segurança código gerado por LLM em contêineres isolados, em 7 linguagens e 3 backends de contêiner.

**Alternativas:**

- [taybenlor/runno](https://github.com/taybenlor/runno) — Executa código em um sandbox WebAssembly no navegador, o Runno.
- [formulahendry/mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner) — Executa código em várias linguagens de programação via a extensão Code Runner.
...
[ShipSwift](https://github.com/signerlabs/ShipSwift) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[indragiek/uniprof](https://github.com/indragiek/uniprof) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[ChiR24/Unreal_mcp](https://github.com/ChiR24/Unreal_mcp) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[squirrelscan](https://github.com/squirrelscan/squirrelscan) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes

QA de sites para agentes de código: audita SEO, performance, segurança e acessibilidade.

**Alternativas:**

- [priyankark/lighthouse-mcp](https://github.com/priyankark/lighthouse-mcp) — Métricas de performance do Google Lighthouse para uma página.
...
[MCP Server for WinDbg Crash Analysis](https://github.com/svnscha/mcp-windbg) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[cameroncooke/XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
