...
[Claude Code official plugin directory](https://github.com/anthropics/claude-plugins-official) — `Marketplace de plugins` · ★ 37k · Licença: Apache-2.0 · Funciona com: Claude Code apenas
