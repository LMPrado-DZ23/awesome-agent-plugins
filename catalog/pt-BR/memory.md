...
[bibinprathap/VeritasGraph](https://github.com/bibinprathap/VeritasGraph) — `Servidor MCP` · Licença: ver repo · Funciona com: Todos os clientes
...
[anyproto/anytype-mcp](https://github.com/anyproto/anytype-mcp) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[OMEGA Memory](https://github.com/omega-memory/omega-memory) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes

Memória persistente, coordenação e aprendizado para agentes de IA, local-first, exposta em 25 ferramentas MCP.

**Alternativas:**

- [Vestige](https://github.com/samvallad33/vestige) — Memória local-first para agentes que retrocede para encontrar a causa raiz de uma falha.
- [Compartment](https://github.com/MaxFreedomPollard/Compartment) — Memória agêntica durável, criptografada em repouso, totalmente offline, sem rede nem chave de API.
- [TeleAI-UAGI/telemem](https://github.com/TeleAI-UAGI/telemem) — Memória multimodal de longo prazo, sensível a personagens, compatível com mem0, com opção totalmente local; exige OPENAI_API_KEY.
- [Lyellr88/marm-memory](https://github.com/Lyellr88/marm-memory) — Servidor universal que adiciona memória de IA com busca semântica.
...
[haiku.rag](https://github.com/ggozad/haiku.rag) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[basicmachines-co/basic-memory](https://github.com/basicmachines-co/basic-memory) — `Servidor MCP` · Licença: AGPL-3.0 · Funciona com: Todos os clientes
...
[IWE](https://github.com/iwe-org/iwe) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[cyanheads/obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[Honcho](https://github.com/plastic-labs/honcho) — `Servidor MCP` · Licença: AGPL-3.0 · Funciona com: Todos os clientes
...
[Beever-AI/beever-atlas](https://github.com/Beever-AI/beever-atlas) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
