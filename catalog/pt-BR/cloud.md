...
[vfarcic/dot-ai](https://github.com/vfarcic/dot-ai) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[Sessy — Amazon SES observability](https://github.com/marckohlbrugge/sessy) — `Servidor MCP` · Licença: ver repo · Funciona com: Todos os clientes
...
[Superlog](https://github.com/superloglabs/superlog) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[HeyPuter/puter](https://github.com/HeyPuter/puter) — `Servidor MCP` · Licença: AGPL-3.0 · Funciona com: Todos os clientes
...
[StuMason/coolify-mcp](https://github.com/StuMason/coolify-mcp) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[cr7258/elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[pgEdge/pgedge-postgres-mcp](https://github.com/pgEdge/pgedge-postgres-mcp) — `Servidor MCP` · Licença: PostgreSQL · Funciona com: Todos os clientes
...
[medplum/medplum](https://github.com/medplum/medplum) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[containers/kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[openstatus](https://github.com/openstatusHQ/openstatus) — `Servidor MCP` · Licença: AGPL-3.0 · Funciona com: Todos os clientes
...
[mongodb-js/mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[motherduckdb/mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[ArcadeDB MCP Server](https://github.com/ArcadeData/arcadedb) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[Neon](https://github.com/neondatabase/mcp-server-neon) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[Prometheus MCP Server](https://github.com/pab1it0/prometheus-mcp-server) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[ProxmoxMCP-Plus](https://github.com/RekklesNA/ProxmoxMCP-Plus) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[ClickHouse](https://github.com/ClickHouse/mcp-clickhouse) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[t8y2/dbx](https://github.com/t8y2/dbx) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes

Consulta bancos de dados a partir de agentes de IA usando conexões já configuradas no DBX.

**Alternativas:**

- [DBHub](https://github.com/bytebase/dbhub) — Servidor mínimo e eficiente em tokens para PostgreSQL, MySQL, SQL Server, SQLite e MariaDB.
...
[OSS Snowflake MCP Server](https://github.com/Snowflake-Labs/mcp) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
...
[StackQL MCP Server](https://github.com/stackql/stackql) — `Servidor MCP` · Licença: MIT · Funciona com: Todos os clientes
...
[Terraform](https://github.com/hashicorp/terraform-mcp-server) — `Servidor MCP` · Licença: MPL-2.0 · Funciona com: Todos os clientes
...
[VictoriaMetrics/mcp-victoriametrics](https://github.com/VictoriaMetrics/mcp-victoriametrics) — `Servidor MCP` · Licença: Apache-2.0 · Funciona com: Todos os clientes
