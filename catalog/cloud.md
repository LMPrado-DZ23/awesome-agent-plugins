...
- [Google Cloud agent development CLI](#agents-cli) — CLI and skills that turn any coding assistant into an expert at creating, evaluating and deploying AI agents o…
...
[HeyPuter/puter](https://github.com/HeyPuter/puter) — `MCP server` · ★ 44k · License: AGPL-3.0 · Works with: All clients
...
[google/agents-cli](https://github.com/google/agents-cli) — `Native plugin` · ★ 6.0k · License: Apache-2.0 · Works with: Gemini CLI only

CLI and skills that turn any coding assistant into an expert at creating, evaluating and deploying AI agents on Google Cloud's Agent Development Kit.
...
[grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) — `MCP server` · ★ 3.5k · License: Apache-2.0 · Works with: All clients
...
[medplum/medplum](https://github.com/medplum/medplum) — `MCP server` · ★ 2.7k · License: Apache-2.0 · Works with: All clients
...
[antonbabenko/terraform-skill](https://github.com/antonbabenko/terraform-skill) — `Agent Skills` · ★ 2.4k · License: see repo · Works with: All clients

Skill from a well-known Terraform module maintainer covering testing, module structure, CI/CD and production infrastructure-as-code patterns for Terraform and OpenTofu.
...
[containers/kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server) — `MCP server` · ★ 2.1k · License: Apache-2.0 · Works with: All clients
...
[Terraform](https://github.com/hashicorp/terraform-mcp-server) — `MCP server` · ★ 1.5k · License: MPL-2.0 · Works with: All clients
...
[ArcadeDB MCP Server](https://github.com/ArcadeData/arcadedb) — `MCP server` · ★ 1.2k · License: Apache-2.0 · Works with: All clients
...
[mongodb-js/mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server) — `MCP server` · ★ 1.1k · License: Apache-2.0 · Works with: All clients
