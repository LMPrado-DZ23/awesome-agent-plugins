...
- [Alibaba open code review](#open-code-review) — Hybrid code-review tool battle-tested at Alibaba's scale, combining deterministic pipelines with an LLM agent …
...
[alibaba/open-code-review](https://github.com/alibaba/open-code-review) — `Agent Skills` · ★ 37k · License: Apache-2.0 · Works with: All clients
...
- [hyhmrright/brooks-lint](https://github.com/hyhmrright/brooks-lint) (★ 1.5k) — Smaller AI code-review skill grounded in 12 classic software-engineering books, with severity labels and book citations.
...
[zereight/gitlab-mcp](https://github.com/zereight/gitlab-mcp) — `MCP server` · ★ 2.0k · License: MIT · Works with: All clients
...
[cyanheads/git-mcp-server](https://github.com/cyanheads/git-mcp-server) — `MCP server` · ★ 240 · License: Apache-2.0 · Works with: All clients
